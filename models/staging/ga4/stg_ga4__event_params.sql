WITH unnest_default_event_params AS (
    ...
    SELECT
        ...
        -- { unnest_by_key_alt('event_params', 'source') }} AS event_source,
        -- { unnest_by_key_alt('event_params', 'medium') }} AS event_medium,
        -- { unnest_by_key_alt('event_params', 'campaign') }} AS event_campaign,
